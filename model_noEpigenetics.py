...
class PrimeNet(nn.Module):
    def __init__(self):
        ...
        # 修改第一个卷积层为多尺度卷积层
        self.conv1 = MultiScaleConv2d(6, 14*6)
        self.conv2 = ResidualConvBlock(14*6, 18*6)
        self.conv3 = ResidualConvBlock(18*6, 18*6)

        # 调整归一化层的维度
        self.norm1 = nn.LayerNorm([14*6, 128, 1])
        self.norm2 = nn.LayerNorm([18*6, 64, 1])
        self.norm3 = nn.LayerNorm([18*6, 32, 1])

        # 注意力模块
        self.attn0 = Conv_Attention(6)
        self.attn1 = Conv_Attention(14*6)
        self.attn2 = Conv_Attention(18*6)
        self.attn3 = Conv_Attention(18*6)
        self.attn4 = ChannelAttention(18*6)
